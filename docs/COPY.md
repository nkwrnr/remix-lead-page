...
- **Zip finder button:** **"Gimme that Remix →"** (was "Summon My Remix").
- **"What's inside every can?" cards** (`INSIDE` array): Real Fruit Juice "Real juice. Real flavor. No artificial stuff getting in the way." · Natural Ingredients "Nothing artificial. No mystery flavors. Just ridiculously good taste." · Electrolytes "We pack in electrolytes so tomorrow-you feels just as good as tonight-you." · Low Sugar "Three grams of sugar. We made a drink, not a dessert." (unchanged).
- **"Remix is built different" subtitle:** "The flavor, ritual, and experience of a great cocktail 🤌 without the alcohol, the calories, or the regret. Sip it straight or Spike it with your fav spirit. **Your call boo.** 😘" — "Your call boo." rendered in the green-serif `.cd-accent` (Fraunces italic + citron, size inherited).
- **Flavor bodies:** Mojito "Deep, dark, and a little dangerous. Sip it straight or **spike it your way.** 0.0% ABV, under 20 calories, 3g sugar." · Paloma "Bright, tart, ridiculously easy. The one that disappears first at the party. **Good straight from the can. Great with tequila.** 0.0% ABV, under 20 calories, 3g sugar."
- **Final CTA:** "Don't miss **the next one.**" — "the next one" is lime-green italic (`.cd-final__h em`).
- **Store count:** **161 Walmart stores** (authoritative — 161 unique stores in `remix-store-locations.xlsx`/`served-zips.json`). Use 161 everywhere.
- **Email opt-in (consent):** no checkbox — a single-opt-in italic notice instead: *"By submitting, you agree to receive the coolest drop emails from us. See our privacy policy."* Submitting = consent; `consent`/`consentVersion`/timestamp logged server-side. (`components/redesign/RedesignEmailForm.tsx`.)
